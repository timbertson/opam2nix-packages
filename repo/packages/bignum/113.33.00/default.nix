...
pkgs.stdenv.mkDerivation 
{
  ...
  src = fetchurl 
  {
    sha256 = "1ar9i23r75wcv3vq1qngjd1s536ng04panlif203s8ycyklly8bx";
    url = "https://ocaml.janestreet.com/ocaml-core/113.33/files/bignum-113.33.00.tar.gz";
  };
}
