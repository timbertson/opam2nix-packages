...
pkgs.stdenv.mkDerivation 
{
  ...
  src = fetchurl 
  {
    sha256 = "0a38qgbg60wqd4716r6l6mzg0bming4f7i2h2c2s9xpm5591px49";
    url = "https://ocaml.janestreet.com/ocaml-core/113.33/files/core_extended-113.33.00.tar.gz";
  };
}
