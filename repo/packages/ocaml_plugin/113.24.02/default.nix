...
pkgs.stdenv.mkDerivation 
{
  ...
  src = fetchurl 
  {
    sha256 = "1jbkrla5gcknchdmy885ysgabg52q732src4s0p8ax54gr03x7h1";
    url = "https://ocaml.janestreet.com/ocaml-core/113.24/files/ocaml_plugin-113.24.02.tar.gz";
  };
}
