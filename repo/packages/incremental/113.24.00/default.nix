...
pkgs.stdenv.mkDerivation 
{
  ...
  src = fetchurl 
  {
    sha256 = "0ln8dc126myi0bhcna461rnq7jy1jbsp91djlpaq27kmkkvq54wv";
    url = "https://ocaml.janestreet.com/ocaml-core/113.24/files/incremental-113.24.00.tar.gz";
  };
}
