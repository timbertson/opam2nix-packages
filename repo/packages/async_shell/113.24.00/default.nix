...
pkgs.stdenv.mkDerivation 
{
  ...
  src = fetchurl 
  {
    sha256 = "05jf1544nnsywj527zidpiv884vchmimfs0x9jagdfhp4d1yg0ba";
    url = "https://ocaml.janestreet.com/ocaml-core/113.24/files/async_shell-113.24.00.tar.gz";
  };
}
