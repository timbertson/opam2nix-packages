...
let
    ...
    opamDeps = 
    {
      ...
      toplevel_expect_test = opamSelection.toplevel_expect_test;
...
pkgs.stdenv.mkDerivation 
{
  ...
  src = fetchurl 
  {
    sha256 = "0blic3882ylm9vp89ziiyq4zlyh25f6lj8q24gahdagwarzkl7d3";
    url = "https://ocaml.janestreet.com/ocaml-core/113.33/files/jane-street-tests-113.33.03.tar.gz";
  };
}
