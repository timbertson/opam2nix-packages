...
pkgs.stdenv.mkDerivation 
{
  ...
  src = fetchurl 
  {
    sha256 = "0rdal690qw7sxbfmypp34lw51vimrcvpcppsmfz3jxb4hc3r4bla";
    url = "https://ocaml.janestreet.com/ocaml-core/113.33/files/email_message-113.33.00.tar.gz";
  };
}
