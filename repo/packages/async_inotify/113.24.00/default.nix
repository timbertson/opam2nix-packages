...
pkgs.stdenv.mkDerivation 
{
  ...
  src = fetchurl 
  {
    sha256 = "1hi4w13wmivms6wxjdw54rjsr7cv0irklppchk0xr783yz08gh9g";
    url = "https://ocaml.janestreet.com/ocaml-core/113.24/files/async_inotify-113.24.00.tar.gz";
  };
}
