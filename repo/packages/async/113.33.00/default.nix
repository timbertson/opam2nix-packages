...
pkgs.stdenv.mkDerivation 
{
  ...
  src = fetchurl 
  {
    sha256 = "0ssh3pgyf3y48nplk0ywr0911b34iwkl9b673398ha6qk8vwidfx";
    url = "https://ocaml.janestreet.com/ocaml-core/113.33/files/async-113.33.00.tar.gz";
  };
}
