...
pkgs.stdenv.mkDerivation 
{
  ...
  name = "async_extra-113.33.00+4.03";
  ...
  src = fetchurl 
  {
    sha256 = "1m92s0k21fr0pf38l98jg5mx3il0xkk6bc5r3zwds7h3b889wibk";
    url = "https://ocaml.janestreet.com/ocaml-core/113.33/files/async_extra-113.33.00+4.03.tar.gz";
  };
}
