...
pkgs.stdenv.mkDerivation 
{
  ...
  name = "async_rpc_kernel-113.33.00";
  ...
  src = fetchurl 
  {
    sha256 = "14v8rfc4pqz37kw55m9sf1c6al6sk4pcdi7iqhrbjkz4gqarvc4v";
    url = "https://ocaml.janestreet.com/ocaml-core/113.33/files/async_rpc_kernel-113.33.00.tar.gz";
  };
}
