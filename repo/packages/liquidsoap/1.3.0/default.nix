...
pkgs.stdenv.mkDerivation 
{
  ...
  src = fetchurl 
  {
    sha256 = "0lims0pilbg4r9j6l7v8j6rfcw39nqzvyphzfv458cigprk8d2rn";
    url = "https://github.com/savonet/liquidsoap/releases/download/1.3.0/liquidsoap-1.3.0.tar.bz2";
  };
}
