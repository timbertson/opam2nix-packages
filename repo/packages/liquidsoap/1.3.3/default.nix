...
pkgs.stdenv.mkDerivation 
{
  ...
  src = fetchurl 
  {
    sha256 = "163ls92dakqpz6snlgvrdhi02wyi6sa8phccx3wzh0ywy3k4kn7n";
    url = "https://github.com/savonet/liquidsoap/releases/download/1.3.3/liquidsoap-1.3.3.tar.bz2";
  };
}
