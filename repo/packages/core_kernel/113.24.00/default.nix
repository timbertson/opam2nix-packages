...
pkgs.stdenv.mkDerivation 
{
  ...
  src = fetchurl 
  {
    sha256 = "1ik8rid53bik77nars8cqfnhnysnpwmr520xki7pm16zkgfwsig2";
    url = "https://ocaml.janestreet.com/ocaml-core/113.24/files/core_kernel-113.24.00.tar.gz";
  };
}
