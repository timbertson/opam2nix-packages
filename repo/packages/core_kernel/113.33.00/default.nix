...
pkgs.stdenv.mkDerivation 
{
  ...
  src = fetchurl 
  {
    sha256 = "1q34kinmzx0hia5nxmxxgp39x2rrwx8cdfkpiqnnx36868sh691c";
    url = "https://ocaml.janestreet.com/ocaml-core/113.33/files/core_kernel-113.33.00.tar.gz";
  };
}
