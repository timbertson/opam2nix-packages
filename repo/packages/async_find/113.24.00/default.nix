...
pkgs.stdenv.mkDerivation 
{
  ...
  src = fetchurl 
  {
    sha256 = "0lq2w0vf53dcld5cvb5dhqk5llk8milr4bw8lyjgi2nvm3y9qijj";
    url = "https://ocaml.janestreet.com/ocaml-core/113.24/files/async_find-113.24.00.tar.gz";
  };
}
