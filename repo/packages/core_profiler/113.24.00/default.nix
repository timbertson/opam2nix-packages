...
pkgs.stdenv.mkDerivation 
{
  ...
  src = fetchurl 
  {
    sha256 = "1zqqsf5ldhxnczw65y4wsrglyky783pq5r9cdb39g3p0ccyggqai";
    url = "https://ocaml.janestreet.com/ocaml-core/113.24/files/core_profiler-113.24.00.tar.gz";
  };
}
